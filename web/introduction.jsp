...
<s:iterator value="#session.greeting2">
<!--顶部导航条 -->
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price"><s:property value="productPrice"></s:property></b>  </dd>
                    </li>
...
<div class="pay">
    ...
    <li>
        <div class="clearfix tb-btn tb-btn-basket theme-login">
            <a id="LikBasket" title="加入购物车" href="add?productid=<s:property value="productId"></s:property>"><i></i>加入购物车</a>
        </div>
    </li>
</div>
...
<script>
    function x() {
        window.location.href="add?10000"
    }
</script>
</html>
